...
describe('processMessageText', () => {
  ...
  test("Dedupes double telephone numbers in message.", () => {
    const input = "You can call <tel:+18551234567|+18551234567> for additional help.";
  ...
  test("Dedupes double telephone numbers as well as double link in message.", () => {
    const input = "You can call <tel:+18551234567|+18551234567> for additional help and register here: <https://registration.elections.myflorida.com/CheckVoterStatus|https://registration.elections.myflorida.com/CheckVoterStatus>.";
    const expected = "You can call +18551234567 for additional help and register here: https://registration.elections.myflorida.com/CheckVoterStatus.";
    expect(MessageParser.processMessageText(input)).toBe(expected);
  });
