...
test("Identifies state abbreviation within a sentence.", () => {
  expect(StateParser.determineState("I want to vote in NC please")).toBe("North Carolina");
});

test("Identifies state abbreviation within a sentence, ignores case and periods.", () => {
  expect(StateParser.determineState("I want to vote in f.L. please")).toBe("Florida");
});
...
test("Identifies state abbreviation at end of a sentence, ignores case and spacing.", () => {
  expect(StateParser.determineState("I want to vote in N.c...")).toBe("North Carolina");
});
...
test("Does not interpret parts of words as state abbreviation intent.", () => {
  ...
  expect(StateParser.determineState("How do I vote once I register")).toBe(null);
});
...
test("Identifies state name within a sentence.", () => {
  expect(StateParser.determineState("I want to vote in North Carolina please")).toBe("North Carolina");
});

test("Identifies state name within a sentence, ignores case and spacing.", () => {
  expect(StateParser.determineState("I want to vote in noRtHCaRolinA please")).toBe("North Carolina");
});

test("Identifies state name at start of a sentence.", () => {
  expect(StateParser.determineState("North Carolina please")).toBe("North Carolina");
});

test("Identifies state name at start of a sentence, ignores case and spacing.", () => {
  expect(StateParser.determineState("noRtHCaRolinA please")).toBe("North Carolina");
});

test("Identifies state name at end of a sentence.", () => {
  expect(StateParser.determineState("I want to vote in North Carolina")).toBe("North Carolina");
});

test("Identifies state name at end of a sentence, ignores case and spacing.", () => {
  expect(StateParser.determineState("I want to vote in noRtHCaRolinA")).toBe("North Carolina");
});
...
test("Handles abbreviation of only name part.", () => {
  expect(StateParser.determineState("I want to vote in NCarolina")).toBe("North Carolina");
});

test("Handles abbreviation of only name part, with period.", () => {
  expect(StateParser.determineState("I want to vote in N.Carolina")).toBe("North Carolina");
});
